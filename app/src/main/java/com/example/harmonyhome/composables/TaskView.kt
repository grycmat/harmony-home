...
@Composable
fun TaskView(task: Task, onDismiss: (id: Int) -> Unit) {
    val stdState = rememberDismissState(confirmValueChange = {
        onDismiss(task.id)
        true
    })
    SwipeToDismiss(state = stdState, background = {}, dismissContent = {
        Column(
            Modifier
                .fillMaxWidth()
